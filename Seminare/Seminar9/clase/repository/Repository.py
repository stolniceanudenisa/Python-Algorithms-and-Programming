from seminar10.clase.repository.RepositoryException import DuplicateIDException, InexistentIDException
...
class Repository:
    ...
    def adauga(self, entitate):
        ...
        :return:
        '''
        if self.gaseste_dupa_id(entitate.get_id()) != -1:
    ...
    def modifica(self, entitate_noua):
        ...
        if self.gaseste_dupa_id(id_entitate_noua) == -1:
