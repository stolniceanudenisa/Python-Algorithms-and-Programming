...
class InscriereRepository(Repository):
    ...
    def adauga(self, inscriere):
        ...
        if self.__student_repository.gaseste_dupa_id(student_id) is None or self.__disciplina_repository.gaseste_dupa_id(
                disciplina_id) is None:
            raise KeyError("Studentul sau disciplina inscrierii nu exista!")
        elif self.gaseste_inscriere_dupa_student_id_si_disciplina_id(student_id, disciplina_id) is not None:
