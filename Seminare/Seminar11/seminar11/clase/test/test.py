...
from seminar11.clase.domain.ValidatorException import ValidatorException
from seminar11.clase.domain.DisciplinaValidator import DisciplinaValidator
...
from seminar11.clase.repository.DisciplinaRepository import DisciplinaRepository, InexistentIDException, \
...
def test_disciplina_repository():
    ...
    assert repository.gaseste_dupa_id(2) is None #disciplina cu id=2 nu exista in repository
    ...
    repository.sterge(1)
    assert len(lista_discipline) == 0
    assert repository.gaseste_dupa_id(1) is None #dupa stergere, disciplina cu id=1 nu se mai gaseste in repository
